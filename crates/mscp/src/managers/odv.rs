...
# Generated by: contour mscp odv init --keyword {baseline}
#
# To apply these overrides:
#   contour mscp generate --keyword {baseline} --odv {filename}
#   contour mscp extract-scripts --keyword {baseline} --odv {filename}
